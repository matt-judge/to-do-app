...
var app = new Vue({
  ...
  methods: {
    ...
    completeTask: function completeTask(task) {
      ...
      var key = this.tasks.find(function (x) {
        return x == task;
      });
    ...
    restoreTask: function restoreTask(task) {
      this.tasks.push(task); // Re-adds to array

      var key = this.recentlyCompletedTasks.find(function (x) {
        return x == task;
      });
  ...
  mounted: function mounted() {
    var storedTasks = window.localStorage.getItem('tasks'); // Gets tasks from browser storage
...
module.exports = __webpack_require__(/*! C:\inetpub\wwwroot\www\to-do-app\resources\js\index.js */"./resources/js/index.js");
